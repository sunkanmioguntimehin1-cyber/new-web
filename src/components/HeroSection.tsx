...
//             Where Film, Fashion, Art and AI collide. 2 days of groundbreaking
//             creativity in the heart of Los Angeles.
//           </p>

//           {/* Scrolling Banner */}
//           <div className="mb-12 overflow-hidden bg-gray-900/50 rounded-full py-4">
//             <div className="flex animate-scroll space-x-8 text-gray-300">
//               <span className="whitespace-nowrap">
//                 📽️ Film Submissions Open
//               </span>
//               <span className="whitespace-nowrap">
//                 🎨 Art Exhibitors Welcome
//               </span>
//               <span className="whitespace-nowrap">🎭 Performers Wanted</span>
//               <span className="whitespace-nowrap">👗 Fashion Designers</span>
//               <span className="whitespace-nowrap">💼 Sponsors Needed</span>
//               <span className="whitespace-nowrap">🤝 Volunteers Apply</span>
//               <span className="whitespace-nowrap">📰 Press & Media</span>
//               <span className="whitespace-nowrap">
//                 📽️ Film Submissions Open
//               </span>
//               <span className="whitespace-nowrap">
                ...
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="text-cyan-400 text-sm font-mono tracking-wider mb-6">
                      LOS ANGELES • NOV 14–15, 2025 • 10AM DAILY
                    </div>
                  </div>
